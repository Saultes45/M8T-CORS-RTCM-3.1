...
trap_ctrlc()
{
	if [ "$CORSFinished" = false ] ; then # Continue the rest of the program
		...
		read -p "Waiting for Latitude (1/3): " var1

		read -p "Waiting for Longitude (2/3): " var2

		read -p "Waiting for Altitude (3/3): " var3

		# Stream the RTCM3 content with the following messages
		# 1005,1006,1008,1033,1074,1013,1084,1094,1114,1124 (as AUCK_RTCM-MSM)
		# Station is chosen as ID 445
...
# This is the passthrough: RPi is a glorified Serial2Wifi converter
